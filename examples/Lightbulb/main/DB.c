 ...
 * CO Service
 */
const HAPFloatCharacteristic COCharacteristic = {
    .format = kHAPCharacteristicFormat_Float,
    .iid = kIID_COName,
    .characteristicType = &kHAPCharacteristicType_AirParticulateDensity,
    .debugDescription = kHAPCharacteristicDebugDescription_AirParticulateDensity,
    .manufacturerDescription = NULL,
    .properties = { .readable = true,
                    .writable = false,
                    .supportsEventNotification = true,
    ...
    .callbacks = { .handleRead = HandleCORead, .handleWrite = NULL }
};

const HAPUInt8Characteristic CODetectCharacteristic = {
    .format = kHAPCharacteristicFormat_UInt8,
    .iid = kIID_COdetect,
    ...
    .properties = { .readable = true,
                    ...
                    .ble = { .supportsBroadcastNotification = true,
                             ...
                             .readableWithoutSecurity = false,
                             .writableWithoutSecurity = false } },
    .constraints = { .maximumValue = 1, .minimumValue = 0 },
